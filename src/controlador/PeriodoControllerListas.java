...
public class PeriodoControllerListas extends DataAccesObject<PeriodoAcademico>{
    ...
    public Boolean save() {
        ...
        if(id != 1){
            try {
                PeriodoAcademico periodoant = getPeriodos().get(id-1);
                periodoant.setEstado(false);
                update(periodoant, id-1);
            } catch (Exception e) {
